...
<%
	...
	String redirectURI = URLEncoder.encode("http://localhost:9091/WebProject1/callback_naver_join.jsp", "UTF-8");
...
<link rel="stylesheet" href="css/Join_home.css"/>
<script>
...
<body>
    <div id="content">
		...
		<input type="hidden" name="command" value="code_join_before"/>
        <input type="email" class="join_email" name="email" placeholder="name@company.com" required/>
