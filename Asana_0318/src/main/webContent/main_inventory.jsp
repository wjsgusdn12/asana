...
<%
	MemberAllDto memberAllDto = (MemberAllDto)request.getAttribute("memberAllDto");
	ArrayList<AlarmUpdateDto> alarmUpdateList = (ArrayList<AlarmUpdateDto>)request.getAttribute("alarmUpdateList");
	ArrayList<PortfolioAllDto> portfolioAllDto = (ArrayList<PortfolioAllDto>)request.getAttribute("portfolioAllDto");
	PortfolioDao portfolioDao = (PortfolioDao)request.getAttribute("portfolioDao");
	ArrayList<WamAllDto> dtolist = (ArrayList<WamAllDto>)request.getAttribute("dtolist");
...
<head>
<meta charset="UTF-8">
<title>Asana 목록</title>
<link rel="stylesheet" href="css/main_inventory.css" />
...
//		alert("서버로부터의 메시지 : " + e.data);
	...
	$(function() {
		...
		//길주 plus_icon_coooperation
		$(".plus_icon_coooperation> svg").click(function() { 
			$(".show_cooperation").css("display","flex");
			$(".assignmentOfmanager_list").css("display","block");
		});
		// 협업참여자 안에서 x 버튼
		$(".bi-x").click(function() { 
			alert("!");
		...
		// 협업참여자 추가 후 프로필 넣기
		$(".assignmentOfmanager_list_select").click(function() { 
			$(".show_cooperation").hide();
			$(".assignmentOfmanager_list").hide();
			$(".member_cooperation").show();
		});
		...
		//작업추가 팝업 나오기 
		$(".spread_sheet_Header_Structure_generation").click(function(){
	...
	$(function(){
		...
		$(document).on("click", ".spread_sheet_Header_Structure", function(){
	 ...
	 */								
		...
		//작업 완료 체크기능 
		$(document).on("click", ".check_svg", function(){
			let wamidx = $(this).closest(".spread_sheet_Header_Structure").attr("wamidx");
			...
			$.ajax({
				...
				success:function(data){
					...
					for(let i=0; i<completeobj.length; i++){
						let str = `<div class="spread_sheet_Header_Structure"
							wamidx="`+completeobj[i].wamidx01+`">
							<div class="work_name">
								<svg
										class="check_svg"
										viewBox="0 0 32 32" aria-hidden="true" focusable="false">
									 <path
											d="M31,16c0,8.3-6.7,15-15,15S1,24.3,1,16S7.7,1,16,1S31,7.7,31,16z"
											class="CompoundIcon-outer" style="fill:#5da283; stroke:#5da283;"></path>
									 <path
											d="M13.4,22.1c-0.3,0-0.5-0.1-0.7-0.3l-3.9-3.9c-0.4-0.4-0.4-1,0-1.4s1-0.4,1.4,0l3.1,3.1l8.1-8.1c0.4-0.4,1-0.4,1.4,0   s0.4,1,0,1.4l-8.9,8.9C13.9,22,13.7,22.1,13.4,22.1z"
											class="CompoundIcon-inner" style="fill:#f5f4f3;"></path>
								 </svg>
								`+completeobj[i].title+`
							</div>
							<div class="manager">
								`+completeobj[i].nickname+`
							</div>
							<div class="deadline_section">`
							if(completeobj[i].deadlineformatDate != null){
								str+=completeobj[i].deadlineformatDate
							}else{
								str+=`<div class="manager_generation_div">
										<svg
										class="HighlightSol HighlightSol--core MiniIcon UserMiniIcon"
							...
							str += `</div>
								<div class="collaboration_participants">협업 참여자</div>
								<div class="user_created">
									`+completeobj[i].createnickname+`
								</div>
								<div class="creation_date">
									`+completeobj[i].createPostDate+`
								</div>
								<div class="last_modified_date">
									`+completeobj[i].correctionFormat+`
								</div>
								<div class="completion_date">
									`+completeobj[i].completeDateFormat+`
								</div>
								<div class="plus_icon_div"></div>
							</div>`
					...
					for(let i=0; i<runningobj.length; i++){
						let str = `<div class="spread_sheet_Header_Structure"
							wamidx="`+runningobj[i].wamidx01+`">
							<div class="work_name">`
							/* 조건이 선행이 있다면 모래시계 선행이 없다면 체크  */
							if(runningobj[i].completedatecheck>0){
								str+=`<svg class="HighlightSol HighlightSol--core Icon TaskRowCompletionStatus-taskIcon HourglassIcon" viewBox="0 0 32 32" aria-hidden="true" focusable="false">
								<path d="M29 28h-3v-4.677c0-1.895-.887-3.687-2.369-4.793a20.347 20.347 0 0 0-4.517-2.529 20.358 20.358 0 0 0 4.516-2.529C25.113 12.366 26 10.574 26 8.678V4.001h3a1 1 0 1 0 0-2H3a1 1 0 1 0 0 2h3v4.677c0 1.895.885 3.687 2.367 4.793A20.347 20.347 0 0 0 12.884 16a20.358 20.358 0 0 0-4.516 2.53C6.885 19.634 6 21.426 6 23.322V28H3a1 1 0 1 0 0 2h26a1 1 0 1 0 0-2ZM9.562 11.868C8.584 11.137 8 9.944 8 8.677V4h16v4.677c0 1.267-.585 2.46-1.564 3.191-1.928 1.438-4.035 2.454-6.436 3.099-2.4-.645-4.509-1.661-6.436-3.099ZM24 28H8v-4.677c0-1.267.585-2.46 1.564-3.191 1.928-1.438 4.035-2.454 6.436-3.099 2.401.645 4.51 1.66 6.436 3.098.98.731 1.564 1.924 1.564 3.191V28Z"></path>
								</svg>`
							}else{
								str+=`<svg
							...
							str+=runningobj[i].title+
							`</div>
							<div class="manager">
								`+runningobj[i].nickname+`
							</div>
							<div class="deadline_section">`
							if(runningobj[i].deadlineformatDate != null){
								str+=runningobj[i].deadlineformatDate
							}else{
								str+=`<div class="manager_generation_div">
										<svg
										class="HighlightSol HighlightSol--core MiniIcon UserMiniIcon"
							...
							str += `</div>
								<div class="collaboration_participants">협업 참여자</div>
								<div class="user_created">
									`+runningobj[i].createnickname+`
								</div>
								<div class="creation_date">
									`+runningobj[i].createPostDate+`
								</div>
								<div class="last_modified_date">
									`+runningobj[i].correctionFormat+`
								</div>
								<div class="completion_date">
									`+runningobj[i].completeDateFormat+`
								</div>
								<div class="plus_icon_div"></div>
							</div>`
					...
					for(let i=0; i<allobj.length; i++){
						let str = `<div class="spread_sheet_Header_Structure"
							...
							<div class="deadline_section">`
							if(allobj[i].deadlineformatDate != null){
								str+=allobj[i].deadlineformatDate
							}else{
								str+=`<div class="manager_generation_div">
										<svg
										class="HighlightSol HighlightSol--core MiniIcon UserMiniIcon"
							...
							str += `</div>
								<div class="collaboration_participants">협업 참여자</div>
								<div class="user_created">
									`+allobj[i].createnickname+`
								</div>
								<div class="creation_date">
									`+allobj[i].createPostDate+`
								</div>
								<div class="last_modified_date">
									`+allobj[i].correctionFormat+`
								</div>
								<div class="completion_date">
									`+allobj[i].completeDateFormat+`
								</div>
								<div class="plus_icon_div"></div>
							</div>`
			...
			<div id="main_outline">
				<div id="header">
					<div id="header1">
						...
						<!-- 포트폴리오 이름 조회  -->
						<!-- 포트폴리오 이름 조회  -->
						<%for (PortfolioAllDto dto1 : portfolioAllDto) {
							System.out.println("portfolioIdx: " + dto1.getPortfolioIdx());
							PortfolioAllDto portfolioAllDto02 = portfolioDao.getPortfolioDto(dto1.getPortfolioIdx());%>
							<div id="employment">
								...
								<span><%=portfolioAllDto02.getName()%></span>
								<svg
						...
						<div style="width: auto;" class="list-image">
							<img style="z-index: 4;" class="img-small" src="..\..\img01\짱구1.jpg"> 
							<img style="z-index: 3; margin-left: -10px;" class="img-small" src="..\..\img01\짱구2.jpg"> 
							<img style="z-index: 2; margin-left: -10px;" class="img-small" src="..\..\img01\철수.png">
						</div>
						<div id="share_button">
							<svg class="MiniIcon LockFillMiniIcon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
						<path d="M19.499 8h-1.5V6c0-3.309-2.691-6-6-6s-6 2.691-6 6v2h-1.5a2.503 2.503 0 0 0-2.5 2.5v9c0 1.378 1.121 2.5 2.5 2.5h15c1.379 0 2.5-1.122 2.5-2.5v-9c0-1.378-1.121-2.5-2.5-2.5Zm-3.5 0h-8V6c0-2.206 1.794-4 4-4s4 1.794 4 4v2Z"></path></svg>
							<span>공유</span>
						</div>
						<div id="horizontal_line"></div>
						<div id="customized">
							<img class="DeprecatedMiniIllustration DeprecatedMiniIllustration--smallMiniIcon ButtonThemeablePresentation-leftIcon" alt="" src="https://d3ki9tyy5l5ruj.cloudfront.net/obj/ce625ef5536516f31458c34d0c9d41457cae8470/customize_12.svg">
							<span>사용자 지정</span>
						</div>
					</div>
					<div id="header2">
						...
						<div id="project_title">
							<span>${projectAllDto_getName}</span>
							<svg class="first_icon" style="margin-top: 7px;" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
						<path d="m18.185 7.851-6.186 5.191-6.186-5.191a1.499 1.499 0 1 0-1.928 2.298l7.15 6a1.498 1.498 0 0 0 1.928 0l7.15-6a1.5 1.5 0 0 0-1.928-2.298Z"></path></svg>
							<!-- 별 html -->
							<!-- 별 html -->
							<!-- 별 html -->
						...
						<div class="click_status_update header_click_status_update">
							...
							<div class="DownIcon">
								<svg class="ArrowDown" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
									<path d="m18.185 7.851-6.186 5.191-6.186-5.191a1.499 1.499 0 1 0-1.928 2.298l7.15 6a1.498 1.498 0 0 0 1.928 0l7.15-6a1.5 1.5 0 0 0-1.928-2.298Z"></path></svg>
							</div>
							<!--상태설정 체인지-->
							<div class="progress_change_green">
								<div class="green">
									<div class="green_circle">
										<svg class="status_green" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
											<path d="m20,12c0,4.42-3.58,8-8,8s-8-3.58-8-8S7.58,4,12,4s8,3.58,8,8Z"></path></svg>
									</div>
							...
							<div class="progress_change_yellow">
								<div class="yellow">
									<div class="yellow_circle">
										<svg class="status_yellow" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
											<path d="m20,12c0,4.42-3.58,8-8,8s-8-3.58-8-8S7.58,4,12,4s8,3.58,8,8Z"></path></svg>
									</div>
							...
							<div class="progress_change_red">
								<div class="red">
									<div class="red_circle">
										<svg class="status_red" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
											<path d="m20,12c0,4.42-3.58,8-8,8s-8-3.58-8-8S7.58,4,12,4s8,3.58,8,8Z"></path></svg>
									</div>
									<div class="red_span">
										<span>계획에서 벗어남</span>
							...
							<div class="progress_change_blue">
								<div class="blue">
									<div class="blue_circle">
										<svg class="status_blue" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
											<path d="m20,12c0,4.42-3.58,8-8,8s-8-3.58-8-8S7.58,4,12,4s8,3.58,8,8Z"></path></svg>
									</div>
									<div class="blue_span">
										<span>보류 중</span>
							...
							<div class="progress_change_complete">
								<div class="check">
									<div class="complete">
										<svg class="check_icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
					...
					<div id="header3">
						<div id="header3_item">
							<svg class="MiniIcon--small MiniIcon ObjectTabNavigationBarItemWithMenu-icon ProjectMiniIcon" aria-current="false" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
						...
						<div id="header3_item">
							<svg class="MiniIcon--small MiniIcon ObjectTabNavigationBarItemWithMenu-icon ListViewMiniIcon" aria-current="true" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
						...
						<div id="header3_item">
							<svg class="MiniIcon--small MiniIcon ObjectTabNavigationBarItemWithMenu-icon BoardMiniIcon" aria-current="false" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
						...
						<div id="header3_item">
							<svg class="MiniIcon--small MiniIcon ObjectTabNavigationBarItemWithMenu-icon AttachVerticalMiniIcon" aria-current="false" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
						...
						<div id="header3_item">
							<svg class="MiniIcon--small MiniIcon ObjectTabNavigationBarItemWithMenu-icon DocumentMiniIcon" aria-current="false" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
				...
				<div id="main_content">
					...
					<div class="spread_sheet_Header_Structure">
						<div class="work_name">작업 이름</div>
						<div class="manager">담당자</div>
						<div class="deadline_section">마감일</div>
						<div class="collaboration_participants">협업 참여자</div>
						<div class="user_created">생성한 사용자</div>
						<div class="creation_date">생성일</div>
						<div class="last_modified_date">마지막 수정일</div>
						<div class="completion_date">완료일</div>
						<div class="plus_icon_div">
							<!-- <svg
								class="HighlightSol HighlightSol--core MiniIcon PlusMiniIcon"
								viewBox="0 0 24 24" aria-hidden="true" focusable="false">
								<path
									d="M10,10V4c0-1.1,0.9-2,2-2s2,0.9,2,2v6h6c1.1,0,2,0.9,2,2s-0.9,2-2,2h-6v6c0,1.1-0.9,2-2,2s-2-0.9-2-2v-6H4c-1.1,0-2-0.9-2-2s0.9-2,2-2H10z"></path></svg> -->
						</div>
					</div>
					<div class="wam_section_title">
						<div class="wam_section_title_child">
							<div class="wam_section_title_child_svg">
								<svg
									class="HighlightSol HighlightSol--core Icon DownTriangleIcon"
									viewBox="0 0 32 32" aria-hidden="true" focusable="false">
									<path
										d="M25.422 12.617a1 1 0 0 0-.924-.617h-17a1 1 0 0 0-.707 1.707l8.5 8.5a.997.997 0 0 0 1.414 0l8.5-8.5a1 1 0 0 0 .217-1.09Z"></path></svg>
							</div>
							<div class="button_with_section_name">완료</div>
						</div>
					</div>
					<div class="spread_sheet_Header_Structure_generation">
						<div class="work_name_generation">
							<svg
							...
							<input name="work_name" type="text" value="작업 추가 ..." />
						</div>
						<div class="manager_generation">
						...
						<div class="deadline_section_generation">
							<div class="deadline_section_generation_div">
								<svg
									class="HighlightSol HighlightSol--core MiniIcon CalendarMiniIcon"
									viewBox="0 0 24 24" aria-hidden="true" focusable="false">
									<path
						...
						<div class="collaboration_participants_generation">
							<img src="img01/짱구1.jpg" />
						</div>
						<div class="user_created_generation">지수</div>
						<div class="creation_date_generation">오늘</div>
						<div class="last_modified_date_generation">오늘</div>
						<div class="completion_date_generation"></div>
					</div>
					<!-- 프로젝트의 wam 목록 조회  -->
					<!-- 프로젝트의 wam 목록 조회  -->
					<!-- 프로젝트의 wam 목록 조회  -->
					...
					<%
					for (WamAllDto dto01 : dtolist) {
						String completeDate = dto01.getCompleteDate();
						int wamidx = dto01.getWamIdx(); //wamidx 
						WamDao wamdao = new WamDao();
						ArrayList<WamAllDto> completedtolist = wamdao.precedingWamGet(wamidx); //wamidx 에 선행이 있는지 확인 
						if (completeDate != null) {
					%>
					<div class="spread_sheet_Header_Structure"
						wamidx="<%=dto01.getWamIdx()%>">
						<div class="work_name">
							<svg
									class="check_svg"
									viewBox="0 0 32 32" aria-hidden="true" focusable="false">
						...
						<div class="deadline_section">
							<%
							String deadlineDate = dto01.getDeadlineDate();
							...
							String FormatPostDate = null;
							if (deadlineDate != null) {
								Date projectStatusDate = formatterDate01.parse(deadlineDate.split(" ")[0]);
								FormatPostDate = formatterDate02.format(projectStatusDate);
							}
							%>
							<%
						...
						<div class="user_created">
							<%
							int createIdx = dto01.getCreatorIdx(); //생성한 사용자 idx 
							MemberAllDto memberAllDto02 = memberDao.getMemberAllDto(createIdx);
							%>
							<%=memberAllDto02.getNickname()%>
						</div>
						<div class="creation_date">
							<%
							String createDate = dto01.getCreateDate();
							Date statusdatePre02 = formatter1.parse(createDate);
							String createDateFormat = formatter2.format(statusdatePre02);
							%>
							<%=createDateFormat%>
						</div>
						<div class="last_modified_date">
							<%
							String CorrectionDate = dto01.getCorrectionDate();
							String correctionFormat = null;
							if (CorrectionDate != null) {
								Date statusdatePre03 = formatter1.parse(CorrectionDate);
								correctionFormat = formatter2.format(statusdatePre03);
							}
							%>
							<%
							if (correctionFormat != null) {
							%>
							<%=correctionFormat%>
							<%
							}
						...
						<div class="completion_date">
							<%
							String completeFormat = null;
							if (completeDate != null) {
								Date completeDatePre = formatter1.parse(completeDate);
								completeFormat = formatter2.format(completeDatePre);
							}
							%>
							<%
					...
					<div class="wam_section_title">
						<div class="wam_section_title_child">
							...
							<div class="button_with_section_name">수행중</div>
						</div>
					</div>
					<div class="spread_sheet_Header_Structure_generation">
						<div class="work_name_generation">
					...
					for (WamAllDto dto01 : dtolist) {
						String completeDate = dto01.getCompleteDate();
						int wamidx = dto01.getWamIdx(); //당시의 wamidx 
						WamDao wamdao = new WamDao();
						ArrayList<WamAllDto> completedtolist = wamdao.precedingWamGet(wamidx); // 선행이 있는지 확인하는 메서드 
						if (completeDate == null) {%>
						<div class="spread_sheet_Header_Structure"
						wamidx="<%=dto01.getWamIdx()%>">
						<div class="work_name">
							<%
							if(completedtolist.size()==0){
								%>
								<svg
									class="check_svg"
									viewBox="0 0 32 32" aria-hidden="true" focusable="false">
					...
					<div class="wam_section_title">
						<div class="wam_section_title_child">
							...
							<div class="button_with_section_name">모두</div>
						</div>
					</div>
					<div class="spread_sheet_Header_Structure_generation">
						<div class="work_name_generation">
					...
					for (WamAllDto dto01 : dtolist) {
						...
						int wamidx = dto01.getWamIdx(); //당시 idx 
						WamDao wamdao = new WamDao();
						ArrayList<WamAllDto> completedtolist = wamdao.precedingWamGet(wamidx); //선행이 있는지 확인하는 리스트 
						%>
						<div class="spread_sheet_Header_Structure"
						wamidx="<%=dto01.getWamIdx()%>">
						<%String completeDate = dto01.getCompleteDate();
					...
					<div class="blank_rowstructure">
						...
						<div class="blank_manager_right" manageridx="">
							<div class="blank_manager_right_img">
								<img src="img01/<%=memberAllDto.getProfileImg()%>"></img>
							</div>
							<span><%=memberAllDto.getNickname()%></span>
