...
@WebServlet("/ExClickProjectStatus")
public class ExClickProjectStatus extends HttpServlet {
	private static final long serialVersionUID = 1L;
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		int clickProjectStatusIdx = Integer.parseInt(request.getParameter("clickProjectStatusIdx"));
		...
		try {
			projectStatusDto = projectDao.projectStatusUpdateDetails(clickProjectStatusIdx);
		} catch (Exception e) {
